                      ...
                      <div className="bg-white border border-gray-200 rounded-lg p-4">
                        ...
                        <div className="grid grid-cols-4 gap-3">
                          ...
                          <div>
                            ...
                            <select className="block w-full px-3 py-2 rounded-md border border-gray-300  focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-sm bg-gray-50" disabled>
                              <option>kg</option>
                            </select>
                          </div>
